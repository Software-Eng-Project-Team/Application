...
<script type="text/javascript">
	...
	ref.once('value',(data) => {
		data.forEach((data) =>{
			var content = '';
			var val = data.val();
			var show = val.Time + '<br>' + '<br>'+ "<div class='card'></div>"+'<br>';
			var show2 = val.Name+ '<br>' + '<br>'+ "<div class='card'></div>"+'<br>';
			var show4 = val.Event + '<br>' + '<br>'+ "<div class='card'></div>"+'<br>';
			var show5 = val.Date + '<br>' + '<br>'+ "<div class='card'></div>"+'<br>';
			var show6 = val.Guard + '<br>' + '<br>'+ "<div class='card'></div>"+'<br>';

			document.getElementById('show') . innerHTML += show;
			document.getElementById('show2') . innerHTML += show2;
			document.getElementById('show4') . innerHTML += show4;
			document.getElementById('show5') . innerHTML += show5;
			document.getElementById('show6') . innerHTML += show6;
		}); 
